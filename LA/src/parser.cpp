...
//Instruction call rule    
  ...
  */
  ...
  static void apply( const Input & in, Program & p)
    {
        parsed_items.push_back(&LA::int64_anno_ex);  
    }
  };
  ...
  static void apply( const Input & in, Program & p)
    {
        parsed_items.push_back(&LA::tuple_anno_ex);
    }
  };
  ...
  static void apply( const Input & in, Program & p)
    {
        parsed_items.push_back(&LA::void_anno_ex);
    }
  };
  ...
  static void apply( const Input & in, Program & p)
    {
        parsed_items.push_back(&LA::code_anno_ex);
    }
  };
...
//   }};
  ...
  */
  ...
  {        
    ...
    parsed_items.pop_back();
    auto ins = new Instruction_branch_condi(dst1,dst2,condition);
    F->insts.push_back(ins);
  }
  };
  //call function rule
