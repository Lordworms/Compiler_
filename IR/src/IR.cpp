...
namespace IR
{
    ...
    {
        return callee==&IR::runtime_print||callee==&IR::runtime_allocate||callee==&IR::runtime_input||callee==&IR::runtime_tensor;
    }
    /*
    ...
    */
    ...
    //for get successor
    std::set<BasicBlock*> Instruction_ret::get_successor(std::map<Label_item*,BasicBlock*>& mp)
    {
        std::set<BasicBlock*> res;
        return res;
    }
    std::set<BasicBlock*> Instruction_var_ret::get_successor(std::map<Label_item*,BasicBlock*>& mp)
    {
        std::set<BasicBlock*>res;
        return res;    
    }
    std::set<BasicBlock*> Instruction_branch_condi::get_successor(std::map<Label_item*,BasicBlock*>& mp)
    {
        std::set<BasicBlock*>res;
        res.insert(mp[(Label_item*)this->location1]);
        res.insert(mp[(Label_item*)this->location2]);
        return res;
    }
    std::set<BasicBlock*> Instruction_branch_nocondi::get_successor(std::map<Label_item*,BasicBlock*>& mp)
    {
        std::set<BasicBlock*>res;
        res.insert(mp[(Label_item*)this->location]);
        return res;
    }
    /*
    ...
    */
    Function::Function()
    {
        ...
        this->blocks=std::vector<BasicBlock*>();
